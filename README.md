...
Проект находится на стадии первого рабочего вертикального среза. Уже доступны обнаружение устройств, карта, ло��альное хранилище и журнал событий. Следующими расширениями могут стать SNMP/LLDP/CDP, WMI/WinRM/SSH-мониторы, планировщик проверок, уведомления и дополнительные форматы экспорта.
